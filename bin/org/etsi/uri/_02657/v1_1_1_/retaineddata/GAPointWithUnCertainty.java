...
@XmlType(name = "GA_PointWithUnCertainty", propOrder = {
    "geographicalCoordinates",
    "uncertaintyCode"
})
public class GAPointWithUnCertainty {

    @XmlElement(required = true)
    protected GeographicalCoordinates geographicalCoordinates;
    protected short uncertaintyCode;
     ...
     * 
     */
    public short getUncertaintyCode() {
     ...
     * 
     */
    public void setUncertaintyCode(short value) {
